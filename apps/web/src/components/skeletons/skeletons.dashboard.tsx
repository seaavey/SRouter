...
export function DashboardSkeleton() {
    return (
        <div className="mx-auto flex w-full max-w-[1360px] flex-col gap-8 font-mono">
            ...
            <div className="grid grid-cols-1 divide-y divide-border/70 overflow-hidden border-y border-border/80 sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-4">
                {Array.from({ length: 4 }).map((_, i) => (
                    <div
                        key={i}
                        className="flex min-h-32 flex-col justify-between bg-card p-4 space-y-3 sm:p-5"
                    >
            ...
            <div className="grid min-w-0 gap-5 lg:grid-cols-[minmax(0,1.35fr)_minmax(20rem,0.65fr)]">
                <div className="rounded-lg border border-border/80 bg-card p-4 sm:p-5 space-y-4 min-h-[300px]">
            ...
            <div className="rounded-lg border border-border/80 bg-card p-4 sm:p-5 space-y-4 min-h-[250px]">
                <div className="flex items-center justify-between border-b border-border/60 pb-3">
